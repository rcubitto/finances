  ...
  <div class="bg-indigo-dark">
    <div class="container mx-auto">
      <div class="flex items-center">
        ...
        >
          <path
            class="text-indigo-lighter fill-current"
        ...
        <h1 class="text-indigo-lightest text-xl font-normal flex items-center">
          Financial Control
        </h1>
        <div class="flex ml-10">
          <RouterLink
            ...
            :key="index"
            :to="route.path"
            class="text-indigo-lighter no-underline uppercase text-xs hover:text-indigo-lightest hover:bg-indigo px-4 py-6"
          >
            {{ route.name }}
          </RouterLink>
        </div>
